      ...
      <DialogContent className='sm:max-w-[425px]'>
        <DialogHeader>
          <DialogTitle className='flex gap-2'>
            Add task to collection: <span className={cn("p-[1px] bg-clip-text text-transparent", CollectionColors[collection.color as keyof typeof CollectionColors])}>{collection.name}</span>
          </DialogTitle>
          <DialogDescription>
                    ...
                    <FormControl>
                      <Popover>
                        <PopoverTrigger asChild>
                          <Button 
                            variant={"outline"}
                            className={cn("justify-start text-left font-normal w-full", !field.value && "text-muted-foreground")}>
        ...
        <DialogFooter>
          <Button 
            ...
            CollectionColors[collection.color as keyof typeof CollectionColors]
            )}
